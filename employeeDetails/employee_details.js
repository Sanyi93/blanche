const employees = [
    ...
    { id: 2, name: 'Alice Smith', age: 28, department: 'HR', salary: 45000, specialization: 'SQL'},
...
//displaying employees details based on their department - HR
...
//finding employee by Specialization
function findEmployeeBySpec(employeeSpec) {
    ...
    if (foundEmployee){
        ...
        document.getElementById('employeesDetails').innerHTML = 'no employees with such a specizalization found';
    }
}